...
-   **stplanr** a wide range of functions for transport planning

-   **performance** for computing measures to assess model quality

-   **ggpubr** for data visualisation 
...
Next, use `glimpse()` display the *odbus* tibble data table by using the code chunk below.
...
### 2.1.1.1 Extracting the study data 
...
## 2.1.2 Working with Geospatial Data
...
### 2.1.2.1 Importing geospatial data 
...
### 2.2.1 Combining busstop and mpsz
...
### 3.2.1 Visualising desire lines
